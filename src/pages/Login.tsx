  ...
  return <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-primary/10 p-4">
      <div className="w-full max-w-md space-y-6">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <Input id="email" type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="user@sasol.com" required />
              </div>
              <div className="space-y-2">
                <Label htmlFor="password">Password</Label>
                <Input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} placeholder="Enter your password" required />
              </div>
              <Button type="submit" className="w-full bg-gradient-to-r from-primary to-primary-glow hover:opacity-90 transition-opacity" disabled={isLoading}>
            ...
            <div className="mt-6 space-y-2">
              ...
              <div className="grid grid-cols-4 gap-2">
                ...
                <Button variant="outline" size="sm" onClick={() => quickLogin('assessor')} className="flex items-center gap-1">
        ...
        <div className="text-center text-sm text-muted-foreground">
          <p>© 2024 Crowned Nexus Limited. All rights reserved.</p>
        </div>
      </div>
    </div>;
};
